...
data = pd.read_csv('../resources/sensordata.csv',delimiter=";", decimal=",").iloc[:1000,4].astype(float).values
...
# Diagramm erstellen
A,f,phi,D,_ = pd.read_csv('../sensordata_DE_F=0_45-c=0_5-N=100_data=500_maxGen=10000_with_csv').iloc[-1].astype(float).values
